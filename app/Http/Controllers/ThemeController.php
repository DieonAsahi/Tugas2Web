...
class ThemeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.themes.index')->with('successMessage', 'Theme created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('dashboard.themes.index')->with('successMessage', 'Theme updated successfully.');
    }
