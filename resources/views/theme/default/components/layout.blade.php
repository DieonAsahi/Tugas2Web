...
<body style="padding-top: 80px;">
      ...
      <footer class="bg-dark text-white pt-4 mt-5" style="background: linear-gradient(90deg, #3D74B6 0%, #0a3264ff 100%);">
            <div class="container p-3">
                  ...
                  <div class="text-center pb-3">
                        <small>© {{ date('Y') }} Color Art. All rights reserved.</small>
                  </div>
            </div>
      </footer>
