<x-layouts.app :title="__('Themes')">
    ...
    <div class="flex justify-between items-center mb-4">
        <div>
            <form action="{{ route('dashboard.themes.index') }}" method="get">
                @csrf
        ...
        <div>
            <flux:button icon="plus">
                <flux:link href="{{ route('dashboard.themes.create') }}" variant="subtle">Add New Theme</flux:link>
            </flux:button>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <flux:dropdown>
                                ...
                                <flux:menu>
                                    <flux:menu.item icon="pencil" href="{{ route('dashboard.themes.edit', $theme->id) }}">Edit</flux:menu.item>
                                    ...
                                    <form id="delete-form-{{ $theme->id }}" action="{{ route('dashboard.themes.destroy', $theme->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </flux:menu>
