<x-layouts.app :title="__('Themes')">
    ...
    <form action="{{ route('dashboard.themes.update', $theme->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mt-4">
            ...
            <flux:link href="{{ route('dashboard.themes.index') }}" variant="ghost" class="ml-3">Kembali</flux:link>
        </div>
    </form>
</x-layouts.app>